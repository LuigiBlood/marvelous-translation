...
//-Font
seekFile($2AC000)
	insert "../text/pt-br/font.bin"
seekFile($270000)
	insert "../text/pt-br/kanji.bin"
...
//--Search Menu Icons
seekFile($2B6000)
	insert "../gfx/pt-br/tmp/searchmenu.gfx"

//--Misc HUD
seekFile($268000)
	insert "../text/pt-br/icons.bin"	//TransPutt Integration
seekFile($26A400)	//Marvelous - Search Mode Logo
	insert "../gfx/pt-br/tmp/title_search.gfx"

//--Journal Menu Tilemap Hacks
seekFile($2C0A2B)	//SELECTでゲーム画面た & Move & Select Text Hack
map_journal1:
	insert "../gfx/pt-br/journal1_map.bin"
seekFile($2C1189)	//"Save"
map_journal2:
	insert "../gfx/pt-br/journal2_map.bin"
seekFile($2C18C8)	//#に記録していいですか？
					//"Wanna save to entry #?"
map_journal3:
	insert "../gfx/pt-br/journal3_map.bin"
...
seekFile($2CE000)
	insert "../gfx/pt-br/tmp/font_large.bin"
...
pal_ch1_patchiesnote:
	insert "../gfx/pt-br/tmp/patchies_stuck_note.pal"
seekFile($2CAFA0)
pal_ch1_ginaransomletter:
	insert "../gfx/pt-br/tmp/gina_ransom_letter.pal"
seekFile($2CAFE0)
pal_ch1_camptips:
	insert "../gfx/pt-br/tmp/camp_tips.pal"
seekFile($2CB100)
pal_ch1_shipnote:
	insert "../gfx/pt-br/tmp/ship_note_nums.pal"
seekFile($2CB5E0)
pal_ch2_chorelist:
	insert "../gfx/pt-br/tmp/chore_list.pal"
seekFile($2C8820)
pal_ch2_bensongrave:
	insert "../gfx/pt-br/tmp/benson_grave_note.pal"
seekFile($2C8B60)
pal_ch3_mgmtofficesign_bg:
	insert "../gfx/pt-br/tmp/mgmt_office_sign_bg.pal"
seekFile($2C9EE0)
pal_ch3_mgmtofficesign_spr:
	insert "../gfx/pt-br/tmp/mgmt_office_sign_spr.pal"
seekFile($2CC380)
pal_ch4_antbuster:
	insert "../gfx/pt-br/tmp/antbuster.pal"
seekFile($2CC620)
pal_ch5_colonel_note_bg:
	insert "../gfx/pt-br/tmp/colonelpermission_bg.pal"
...
map_teamname:			//18 - $0E286B
	insert "../gfx/pt-br/lz/lz_teamname_map.bin.lz"

gfx_title:				//35 - $121964
	insert "../gfx/pt-br/lz/35.bin.lz"

map_title:				//38 - $123726
	insert "../gfx/pt-br/lz/38.bin.lz"
gfx_intro1:				//39 - $123951
	insert "../gfx/pt-br/lz/39.bin.lz"
gfx_intro2:				//3A - $1246DE
	insert "../gfx/pt-br/lz/3A.bin.lz"
gfx_intro3:				//3B - $12550E
	insert "../gfx/pt-br/lz/3B.bin.lz"
map_intro:				//3C - $1257F6
	insert "../gfx/pt-br/lz/3C.bin.lz"
pal_intro:				//3D - $125ADD
	insert "../gfx/pt-br/lz/3D.bin.lz"
gfx_credits:			//3E - $125BB6
	insert "../gfx/pt-br/lz/3E.bin.lz"
map_credits:			//3F - $12735C
	insert "../gfx/pt-br/lz/3F.bin.lz"

//Search Mode - Tilemaps (48 to 50)
map_ch1_gina_ransom:	//48 - $12A9D0
	insert "../gfx/pt-br/lz/48.bin.lz"

map_ch3_sign:			//4A - $12BDA4
	insert "../gfx/pt-br/lz/4A.bin.lz"
map_ch1_patchiesnote:	//4B - $12C7C8
	insert "../gfx/pt-br/lz/4B.bin.lz"

map_ch1_misc:			//4D - $12DEB0
	insert "../gfx/pt-br/lz/4D.bin.lz"
map_ch1_misc2:			//4E - $12E9BA
	insert "../gfx/pt-br/lz/4E.bin.lz"

map_ch5_colonel_note:	//50
	insert "../gfx/pt-br/lz/50.bin.lz"

//Search Mode - Graphics (51 to ??)
gfx_ch1_gina_ransom:	//53 - $132FC4
	insert "../gfx/pt-br/lz/53.bin.lz"

gfx_ch3_sign:			//56 - $136BFE
	insert "../gfx/pt-br/lz/56.bin.lz"

gfx_ch1_patches_stuck:	//5A - $13C578
	insert "../gfx/pt-br/lz/5A.bin.lz"

gfx_ch2_bensongrave:	//5E - $142CE4
	insert "../gfx/pt-br/lz/5E.bin.lz"
gfx_ch1_camptips:		//5F - $1447AE
	insert "../gfx/pt-br/lz/5F.bin.lz"
gfx_ch2_monster:		//60 - $145F3B
	insert "../gfx/pt-br/lz/60.bin.lz"

gfx_ch2_chorelist:		//62 - $1490F9
	insert "../gfx/pt-br/lz/62.bin.lz"
gfx_ch1_controls:		//63 - $14A478
	insert "../gfx/pt-br/lz/63.bin.lz"
gfx_ch1_ship_notes:		//64 - $14B628
	insert "../gfx/pt-br/lz/64.bin.lz"

gfx_ch5_colonel_note2:	//69 - $151D31
	insert "../gfx/pt-br/lz/69.bin.lz"

//Sprites (B9 to F8)
gfx_kick_smash_minigame://D9 - $1D860C
    insert "../gfx/pt-br/lz/D9.bin.lz"
gfx_title_nintendo:		//DA - $1D948F
	insert "../gfx/pt-br/lz/DA.bin.lz"
gfx_title_sub:			//DB - $1DA5ED
	insert "../gfx/pt-br/lz/DB.bin.lz"

gfx_mgmt_office_spr:	//E0
	insert "../gfx/pt-br/lz/E0.bin.lz"

gfx_ch5_colonel_note1:	//F8 - $1FE99C
	insert "../gfx/pt-br/lz/F8.bin.lz"
...
map_chore_list_1chk_1:
	insert "../gfx/pt-br/tmp/chore_list.map",0x04D0,0x20
map_chore_list_1chk_2:
	insert "../gfx/pt-br/tmp/chore_list.map",0x0510,0x20

map_chore_list_2chk_1:
	insert "../gfx/pt-br/tmp/chore_list.map",0x0590,0x20
map_chore_list_2chk_2:
	insert "../gfx/pt-br/tmp/chore_list.map",0x05D0,0x20

map_chore_list_3chk_1:
	insert "../gfx/pt-br/tmp/chore_list.map",0x0650,0x20
map_chore_list_3chk_2:
	insert "../gfx/pt-br/tmp/chore_list.map",0x0690,0x20
...
map_mgmt_office_empty_1:
	insert "../gfx/pt-br/tmp/mgmt_office_sign_bg.map",0x02A2,0x0C
map_mgmt_office_empty_2:
	insert "../gfx/pt-br/tmp/mgmt_office_sign_bg.map",0x02E2,0x0C

map_mgmt_office_full_1:
	insert "../gfx/pt-br/tmp/mgmt_office_sign_bg.map",0x06A2,0x0C
map_mgmt_office_full_2:
	insert "../gfx/pt-br/tmp/mgmt_office_sign_bg.map",0x06E2,0x0C
...
map_ship_notes_0:
	insert "../gfx/pt-br/tmp/ship_note_nums.map",0x0000,0x0400
map_ship_notes_1:
	insert "../gfx/pt-br/tmp/ship_note_nums.map",0x0400,0x0400
map_ship_notes_2:
	insert "../gfx/pt-br/tmp/ship_note_nums.map",0x0800,0x0400
map_ship_notes_3:
	insert "../gfx/pt-br/tmp/ship_note_nums.map",0x0C00,0x0400
map_ship_notes_4:
	insert "../gfx/pt-br/tmp/ship_note_nums.map",0x1000,0x0400
map_ship_notes_5:
	insert "../gfx/pt-br/tmp/ship_note_solve.map",0x0000,0x0400
...
seekFile($300000)
text_script:
	insert "../text/pt-br/script.bin"
	include "../text/pt-br/menu.asm"
	insert "../text/pt-br/items.bin"
	db $FF

text_script_end:
skipBank()
	insert gfx_chapter1_ani,"../text/pt-br/chapter1.bin"
	insert gfx_chapter2_ani,"../text/pt-br/chapter2.bin"
	insert gfx_chapter3_ani,"../text/pt-br/chapter3.bin"
	insert gfx_chapter4_ani,"../text/pt-br/chapter4.bin"
	insert gfx_chapter5_ani,"../text/pt-br/chapter5.bin"
	insert gfx_ship_notes_solve,"../gfx/pt-br/tmp/ship_note_solve.gfx"
	insert gfx_jp_mgmt_office,"../gfx/jp/56.bin",0x1000
skipBank()
	insert gfx_swooned_ani,"../text/pt-br/swooned.bin"

skipBank()
	//--List of Pixel Widths per Char - for VWF
	insert vwf_width_table,"../text/pt-br/width.tbl"
insert_free_space:
